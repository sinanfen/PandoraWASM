...
public class CategoryService : ICategoryService
{
    ...
    public async Task<IList<CategoryDto>> GetCategories(Guid userId, CancellationToken cancellationToken)
    {
        try
        {
    ...
    public async Task<CategoryDto> GetCategory(Guid categoryId, Guid userId, CancellationToken cancellationToken)
    {
        try
        {
