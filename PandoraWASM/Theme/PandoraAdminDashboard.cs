...
public class PandoraAdminDashboard : MudTheme
{
    public PandoraAdminDashboard()
    {
        ...
        Typography = new Typography()
        {
            Default = new Default()
            {
                FontFamily = new[] { "Montserrat", "Helvetica", "Arial", "Roboto", "Verdana", "Times New Roman", "sans-serif" },
                FontSize = ".875rem",
                FontWeight = 400,
                LineHeight = 1.43,
            ...
            H1 = new H1()
            {
                FontFamily = new[] { "Montserrat", "Helvetica", "Arial", "Roboto", "Georgia", "Times New Roman", "sans-serif" },
                FontSize = "6rem",
                FontWeight = 300,
                LineHeight = 1.167,
